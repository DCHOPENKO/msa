...
public enum CustomerInfoDto {
    ...
    public enum Request{
        ;
        @Schema(name = "CustomerInfoBaseRequest", description = "Customer base information in delivery request")
        public record Base(
    ...
    public enum Response{
        ;
        @Schema(name = "CustomerInfoBaseResponse", description = "Customer base information in delivery response")
        public record Base(
                @Schema(description = "Customer full name", example = "Ivan Ivanov")
                String customerName,
                @Schema(description = "Customer email", example = "ivan-ivanov@gmail.com")
